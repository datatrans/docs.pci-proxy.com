...
{% swagger-parameter in="body" name="returnUrl" type="string" %}
...
{% swagger-response status="400" description="Amount must be at least in the currency's smallest unit. " %}
```java
{
    "error": {
...
| `transStatusReason`      | [transStatusReason](../../3ds-terminology.md#transstatusreason-transaction-status-reason)                    | <p>Provides additional information on the failed 3D authentication</p><p></p> |
