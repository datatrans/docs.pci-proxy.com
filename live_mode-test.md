...
| Login Data | Username & Password to login to our [web admin tool](https://pilot.datatrans.biz/)  |
...
| Click on [Example](https://docs.pci-proxy.com/webservice.html)|Click on [Example](https://docs.pci-proxy.com/show.html)|
