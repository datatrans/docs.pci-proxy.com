...
Whether you receive payment data via API, accept credit cards on your website or collect them in your mobile app, you can use PCI Proxy APIs. Our APIs automatically tokenize the payment information before they ever touch your systems to instantly reduce your PCI scope.

**How do you receive or collect payment data?**

| Environment| From partners
| -------------|
| API|
